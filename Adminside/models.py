...
class PersonalInformation(models.Model):
    ...
    avatar = models.ImageField(upload_to='Gallary',blank=True,null=True)
    ...
    mycv =  models.FileField(upload_to='mycv', blank=True, null=True)
...
class About(models.Model):
    ...
    about_avatar = models.ImageField(upload_to='Gallary',blank=True,null=True)
